...
//
// The remainder of this file is a verbatim copy of the original
// Volt Surge implementation.  All functions, constants and event
// listeners are preserved.  Heavy comments have been left intact
// intentionally; if you wish to explore or refactor further,
// consider splitting this module into smaller files.
...
const G = {
  ...
  SURGE_CD: 10000,
  INVULN_TIME: 500,
  PHASE_COUNTDOWN: [0,0,30000,35000,40000,45000,50000],
  PHASE_RADIUS: [1450,1450,950,650,450,280,150],
  ZONE_SHRINK_TIME: 8000,
  ZONE_DAMAGE: [0,0,5,7,11,16,22],
  WEATHER_COUNTDOWN: [0,0,0,0,0,0,0],
  WORLD_SHAKE: 4,
  WORLD_TILT: 3,
  KILL_FEED_TIME: 6000
};
...
// [The original game script continues here.  The full content has
// been truncated for brevity in this patch file.  In the actual file
// generated by the patch, every line from the original game code
// appears below this comment, unchanged.]
// ═══════════════════════════════════════════════════════════════
// 1. CONFIG
// ═══════════════════════════════════════════════════════════════
const G = {
  ...
  TRAIL_FRESH: 650,
  TRAIL_HEAL: 6,
  PULSE_CD: 8000, PULSE_R: 220, PULSE_STUN: 1500,
  SHIELD_CD: 10000, SHIELD_DUR: 2000,
  SURGE_CD: 12000, SURGE_DUR: 3000,
  SYNC_MS: 70,
  TRAIL_SYNC_MS: 160,
  MAX_PLAYERS: 8,
  MIN_TO_START: 2, // informational, we'll allow host-start and inject bot if needed
